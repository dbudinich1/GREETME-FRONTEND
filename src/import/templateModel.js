...
export function templateInstructions(kind, { generatedUtc } = {}) {
  ...
  return [
    ...
    { heading: "Excel vs CSV", lines: [
      ...
      "Keep this file in .xlsx format when you save it. Saving as CSV removes the dropdowns, formatting, and this Instructions sheet.",
      "CSV templates contain the same columns but cannot include Excel dropdown controls or formatting. CSV is not a smart template, but it can be uploaded for compatibility.",
    ] },
