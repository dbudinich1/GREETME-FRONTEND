...
export function templateInstructions(kind) {
  ...
  return [
    ...
    { heading: "Relationship (Type / Relation / Description)", lines: [
      ...
      "Relation: a specific role within the selected Type (the Relation dropdown updates to match Type).",
      `Description: ${DESCRIPTION_OPTIONS.join(" · ")}.`,
      "The dropdowns help you avoid incompatible values. Leave all three blank to import without a relationship.",
      "Description controls how Greet-Me prioritizes and personalizes the relationship.",
    ] },
    ...
    { heading: "Excel vs CSV", lines: [
      "XLSX is the recommended formatted template (dropdowns, frozen header, column widths, validation).",
      "CSV is available for compatibility but cannot contain dropdowns, frozen panes, column widths, filters, or Excel validation controls.",
    ] },
