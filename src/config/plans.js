  ...
  founders: [
    {
      ...
      price: 14.99,
      period: 'year',
      priceId: 'price_1TtuTbCf7KAA6aLaPpCd0Pun',
    ...
    },
    {
      ...
      price: 24.99,
      period: 'year',
      priceId: 'price_1TtuTcCf7KAA6aLajfuuitXc',
      purchaseType: 'subscription',
    ...
    },
    {
      ...
      price: 44.99,
      period: 'year',
      priceId: 'price_1TtuTcCf7KAA6aLayzIjmHw4',
      purchaseType: 'subscription',
...
export const businessPlans = {
  founders: [
    ...
    },
    {
      ...
      price: 199,
      period: 'year',
      priceId: 'price_1TjZrnCf7KAA6aLatOeA2US0',
      purchaseType: 'subscription',
    ...
    },
    {
      ...
      price: 499,
      period: 'year',
      priceId: 'price_1TjZrqCf7KAA6aLaEdAvDAje',
      purchaseType: 'subscription',
  ...
  standard: [
    {
      ...
      price: 199,
      period: 'year',
      priceId: 'price_1TjZrnCf7KAA6aLa0tbf78Ii',
      purchaseType: 'subscription',
      planTier: 'small_business',
      billingPeriod: 'yearly',
      platformFee: 19.99,
    ...
    },
    {
      ...
      price: 699,
      period: 'year',
      priceId: 'price_1TjZrqCf7KAA6aLa7u151mfX',
      purchaseType: 'subscription',
      planTier: 'business_scale',
      billingPeriod: 'yearly',
      platformFee: 19.99,
