...
// TEAM B — PUBLIC fundraiser referral landing (/#/f/:token). Captures ONLY the opaque token into the
// transient carrier; no auth, no dashboard, no private data. Carrier precursor (dormant; checkout wiring
// is a separate, later tier).
